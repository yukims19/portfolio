...
class Project extends Component {
  ...
  handleClickOutside(event) {
    ...
    var containers = Array.from(document.getElementsByClassName("expand"));
                ...
                cover={
                  <div>
                    ...
                    <div className="hover-cover">
                      <p>
                        This is a usability analysis project on the site -
                        Crunchfield. We used Nielsen's 10 heuristics to assess
                        the usability of the site on both desktop and mobile
                        site.
                      </p>
              ...
              <Card
                ...
                cover={
                  <div>
                    ...
                    <div className="hover-cover">
                      <p>
                        This is a prototye for mobile platforms that supports
                        music stream that focuses on redesigning the process of
                        constructing and managing the playlists based on
                        existing major stream apps.
                      </p>
                      <button onClick={() => this.showModal("mommafung")}>
                        Details
                      </button>
                  ...
                  <div>
                    ...
                    <div className="hover-cover">
                      <p>
                        ...
                        GitHub, Youtube, Twitter and other general information
                        based on a link provided.
                      </p>
                      <a
                        href="https://github.com/yukims19/oneprofile"
                        target="_blank"
                      >
              ...
              <Card
                ...
                cover={
                  <div>
                    ...
                    <div className="hover-cover">
                      <p>
                        This is a web app that enables users to request star or
                        star for specified GitHub Repositories.
                      </p>
